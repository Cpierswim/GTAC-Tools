<%@ Page MaintainScrollPositionOnPostback="true" Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
                ...
                <asp:LoginView ID="LoginView1" runat="server">
                    <AnonymousTemplate>
                        ...
                        <p>
                            ...
                            <br /><i>Note: Use the above link to register with the swim team or the non-competitive team, not swim lessons.</i>
                            <br />
                            <br />
                            <asp:HyperLink ID="ForgotPasswordLink" runat="server" EnableViewState="false" NavigateUrl="~/Account/PasswordMailer.aspx">Forgot password.</asp:HyperLink>
                        </p>
                        <asp:Login ID="LoginUser" runat="server" EnableViewState="false" 
                            DestinationPageUrl="~/Parents/FamilyView.aspx" 
                            OnLoggedIn="LoginUser_LoggedIn" onloginerror="LoginFailure">
                            <LayoutTemplate>
