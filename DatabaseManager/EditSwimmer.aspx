<%@ Page MaintainScrollPositionOnPostback="true" Title="Edit Swimmer - Database Manager" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    &nbsp;<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Group:" SortExpression="GroupID">
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="GroupsDataSource"
                        DataTextField="GroupName" DataValueField="GroupID" Enabled="true" SelectedValue='<%# Bind("GroupID") %>'>
                    </asp:DropDownList>
            ...
            <asp:TemplateField HeaderText="Is In Hy-Tek<br />Database:" SortExpression="IsInDatabase">
                <EditItemTemplate>
                    <asp:DropDownList ID="IsInDatabase" runat="server" SelectedValue='<%# Bind("IsInDatabase") %>'>
                        <asp:ListItem Value="True">Yes</asp:ListItem>
                        <asp:ListItem Value="False">No</asp:ListItem>
                    </asp:DropDownList>
                </EditItemTemplate>
            ...
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    ...
                    &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel"
                        ...
                        PostBackUrl="~/DatabaseManager/Swimmers.aspx"></asp:LinkButton>
                </EditItemTemplate>
                <ItemTemplate>
