<%@ Page MaintainScrollPositionOnPostback="true" Title="Recent Changes Messages - Database Manager" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Messages.aspx.cs" Inherits="DatabaseManager_Messages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="MessageDataSource" runat="server" 
        ...
        SelectMethod="GetMessagesByNotSeenByDatabaseManager" TypeName="MessagesBLL" 
        UpdateMethod="SetMessageAsSeenByDatabaseManager">
        <UpdateParameters>
