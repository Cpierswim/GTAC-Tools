<%@ Page MaintainScrollPositionOnPostback="true" Title="Edit Parents - Database Manager"
    Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditParents.aspx.cs"
            ...
            <asp:TemplateField HeaderText="Home Phone:" SortExpression="HomePhone">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="HomePhoneRegularExpressionValidator" runat="server"
                        ControlToValidate="HomePhoneTextBox" ErrorMessage="Home phone not recognized as a phone number.<br />All Phone numbers must be in the 123-456-7890 format."
            ...
            <asp:TemplateField HeaderText="Cell Phone:" SortExpression="CellPhone">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="CellPhoneRegularExpressionValidator" runat="server"
                        ControlToValidate="CellPhoneTextBox" ErrorMessage="Cell phone number not recognized as a phone number.<br />All Phone numbers must be in the 123-456-7890 format."
                        ForeColor="Red" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}">*</asp:RegularExpressionValidator>
                </EditItemTemplate>
                <HeaderStyle HorizontalAlign="Right" />
            </asp:TemplateField>
