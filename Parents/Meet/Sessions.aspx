<%@ Page Title="Pick Sessions" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <br />
    Click &quot;View Events Offered&quot; to see what events are offered for a session,
    what the (if any) cut times are and the swimmer&#39;s best times. Most meets allow
    the swimmer to enter the meet as long as they are close to the cuts, but some meets
    require proof that the swimmer has the cut down to the .01. If this meet is one
    that requires strict adherence to the cut times, there is usually a note about it
        ...
        <ContentTemplate>
            <asp:Panel ID="DisplayPanel" runat="server">
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="EventID"
                    ...
                    BorderWidth="1px" CellPadding="3" GridLines="Horizontal" ViewStateMode="Disabled">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Best Time">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Must Be Faster Than" SortExpression="SCYFastCut">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Must Be Slower Than" SortExpression="SCYSlowCut">
                            <EditItemTemplate>
    ...
    <br />
    After you click &quot;Save Entries&quot; if there are any changes, the website will
    ATTEMPT to send an confirmation e-mail. This email FREQUENTLY DOES NOT ARRIVE due
    to Spam settings from the web hosting company. If it does arrive, there are 2 ways
    to confirm your entry:<br />
    <ul>
        <li>Come back to this page. If you are entered, the above items will still be checked.</li><li>
            Go to your personal Calendar. If you are entered, the meet will show up on your
            personal calendar.</li></ul>
</asp:Content>
