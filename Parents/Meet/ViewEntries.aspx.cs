...
public partial class Parents_Meet_ViewEntries : System.Web.UI.Page
{
    ...
    protected void RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (BestTimes == null)
        {
            ...
            BestTimes = BestTimesAdapter.GetBestTimesByFamilyID(int.Parse(Profile.FamilyID));
        }
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (LastSubHeaderSwimmer != TempRow["USAID"].ToString())
            {
                ...
                if (tbl != null)
                {
                    ...
                    span.InnerText = TempRow["PreferredName"] + " " + TempRow["LastName"];
