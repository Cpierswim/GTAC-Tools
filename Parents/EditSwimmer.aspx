<%@ Page MaintainScrollPositionOnPostback="true" Title="Edit Swimmer" Language="C#"
    MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditSwimmer.aspx.cs"
    Inherits="Parents_Edit_Swimmer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Label ID="NewSeasonSignUpLabel" runat="server" ForeColor="Red" Text="To sign up for the next season, please review the information that you have previously provided below.  To Sign up for the new season, switch the swimmer to &quot;Active&quot;. &lt;br /&gt;&lt;br /&gt;Make sure to click &quot;Update&quot; at the bottom of the page.&lt;br /&gt;&lt;br /&gt;"
    ...
    <strong>Edits are not saved unless you click "Update" at the bottom of the page.</strong><br />
    &nbsp;<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
        BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
        CellPadding="4" DataKeyNames="USAID" DataSourceID="SwimmerDataSource" ForeColor="Black"
        GridLines="Horizontal" DefaultMode="Edit" Font-Size="0.9em" OnDataBound="DetailsView_DataBound"
        OnItemUpdated="SwimmerUpdated">
        ...
        <Fields>
            <asp:TemplateField HeaderText="Legal First Name:" SortExpression="FirstName">
                <EditItemTemplate>
                    <asp:TextBox ID="LegalFirstNameTextBox" runat="server" Columns="35" MaxLength="35"
                        Text='<%# Bind("FirstName") %>' Enabled="False"></asp:TextBox>
                    ...
                    <a href="javascript:myPopup('whynoedit.htm', 'About','300','300','10','300')">Why is
                        some information uneditable?</a>
                </EditItemTemplate>
                <InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="Middle Name:" SortExpression="MiddleName">
                <EditItemTemplate>
                    <asp:TextBox ID="MiddleNameTextBox" runat="server" Columns="35" MaxLength="35" Text='<%# Bind("MiddleName") %>'
            ...
            <asp:TemplateField HeaderText="Last Name:" SortExpression="LastName">
                <EditItemTemplate>
                    <asp:TextBox ID="LastNameTextBox" runat="server" Columns="35" MaxLength="35" Text='<%# Bind("LastName") %>'
                        Enabled="False"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="Birthday:" SortExpression="Birthday">
                <EditItemTemplate>
                    <asp:DropDownList ID="BirthdayMonthDropDownList" runat="server" Enabled="False">
                    ...
                    <asp:DropDownList ID="BirthdayDayDropDownList" runat="server" Enabled="False">
                    ...
                    <asp:DropDownList ID="BirthdayYearDropDownList" runat="server" Enabled="False">
                    </asp:DropDownList>
                    ...
                    <asp:Button ID="YearNotInListButton" runat="server" OnClick="YearNotInList_Clicked"
                        Text="Year not in list" Visible="False" />
            ...
            <asp:TemplateField HeaderText="Phone Number:" SortExpression="PhoneNumber">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="AthletePhoneNumberTextBox"
                        ErrorMessage="Phone number not recognized.  All phone numbers must be in the format 123-456-7890."
                        ForeColor="Red" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}">*</asp:RegularExpressionValidator>
                    <asp:Label ID="PhoneNumberLabel" runat="server" Font-Bold="False" Font-Size="Small"
                        Text="Athlete's Personal number, not parents."></asp:Label>
                </EditItemTemplate>
                <InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="Email:" SortExpression="Email">
                <EditItemTemplate>
                    ...
                    <asp:Label ID="AthleteEmailLabel" runat="server" Font-Bold="False" Font-Size="Small"
                        Text="Athlete's personal e-mail."></asp:Label>
                </EditItemTemplate>
                <InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="Active Swimmer:" SortExpression="Inactive">
                <EditItemTemplate>
                    ...
                    &nbsp;<asp:Label ID="ActiveSwitcherLabel" runat="server" Font-Bold="False" Font-Size="Small"
                        Text="Change this to &quot;Active&quot; to sign up for the new sesaon." Visible="False"
            ...
            <asp:TemplateField HeaderText="Group:" SortExpression="GroupID">
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="GroupsDataSource"
                        Enabled="false" DataTextField="GroupName" DataValueField="GroupID" SelectedValue='<%# Bind("GroupID") %>'>
                    </asp:DropDownList>
            ...
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    ...
                    &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel"
                        OnClick="CancelButton_Clicked" Text="Cancel"></asp:LinkButton>
                </EditItemTemplate>
                <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="SwimmerDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:SessionParameter Name="USAID" SessionField="EditSwimmer" Type="String" />
        </SelectParameters>
        <UpdateParameters>
