<%@ Page MaintainScrollPositionOnPostback="true" Title="Edit Parents" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="EditParents.aspx.cs" Inherits="Parents_EditParents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br /><br />
    <asp:Button ID="SwitchParentsButton" runat="server" Text="Set this Parent as Primary Contact"
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="ParentID"
        ...
        GridLines="Horizontal" OnDataBound="DetailsView_DataBound" 
        onitemupdated="ParentUpdated">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="First Name:" SortExpression="FirstName">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="FirstNameRequiredFieldValidator" runat="server" 
                        ControlToValidate="FirstNameTextBox" ErrorMessage="First name required." 
            ...
            <asp:TemplateField HeaderText="Address :" SortExpression="AddressLineOne">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="AddressRequiredFieldValidator" runat="server" 
                        ControlToValidate="AddressLineOneTextBox" ErrorMessage="Address Required." 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                </EditItemTemplate>
                <HeaderStyle HorizontalAlign="Right" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="City:" SortExpression="City">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="CityRequiredFieldValidator" runat="server" 
                        ControlToValidate="CityTextBox" ErrorMessage="City required." ForeColor="Red">*</asp:RequiredFieldValidator>
                </EditItemTemplate>
                <HeaderStyle HorizontalAlign="Right" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Zip:" SortExpression="Zip">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="ZipCodeRequiredFieldValidator" runat="server" 
                        ControlToValidate="ZipTextBox" ErrorMessage="Zip code required." 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="ZipCodeRegularExpressionValidator" 
                        runat="server" ControlToValidate="ZipTextBox" 
                        ErrorMessage="Zip code not recognized." ForeColor="Red" 
            ...
            <asp:TemplateField HeaderText="Home Phone:" SortExpression="HomePhone">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="HomePhoneRequiredFieldValidator" runat="server" 
                        ControlToValidate="HomePhoneTextBox" ErrorMessage="Home phone required." 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="HomePhoneRegularExpressionValidator" 
                        runat="server" ControlToValidate="HomePhoneTextBox" 
                        ErrorMessage="Home phone not recognized as a phone number.<br />All Phone numbers must be in the 123-456-7890 format." ForeColor="Red" 
            ...
            <asp:TemplateField HeaderText="Cell Phone:" SortExpression="CellPhone">
                <EditItemTemplate>
                    <asp:TextBox ID="CellPhoneTextBox" runat="server" Text='<%# Bind("CellPhone") %>'
                        Columns="25" MaxLength="25"></asp:TextBox>
                    <asp:RegularExpressionValidator ID="CellPhoneRegularExpressionValidator" 
                        runat="server" ControlToValidate="CellPhoneTextBox" 
                        ErrorMessage="Cell phone number not recognized as a phone number.<br />All Phone numbers must be in the 123-456-7890 format." 
            ...
            <asp:TemplateField HeaderText="Email:" SortExpression="Email">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" 
                        ...
                        ErrorMessage="Email not recognized as an email address." ForeColor="Red" 
    ...
    <asp:ObjectDataSource ID="ParentsDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="FamilyID" QueryStringField="FamilyID" 
                Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
