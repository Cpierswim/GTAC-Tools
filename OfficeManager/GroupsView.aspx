...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    View Group:
    <asp:DropDownList ID="CurrentGroupViewDropDownList" runat="server" AutoPostBack="True"
        DataSourceID="GroupsDataSource" DataTextField="GroupName" DataValueField="GroupID"
        OnSelectedIndexChanged="GroupSelectionDropDownList_Changed">
    </asp:DropDownList>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" InsertMethod="InsertSwimmer"
        SelectMethod="GetSwimmersByGroupID" TypeName="SwimmersBLL" UpdateMethod="UpdateGroup"
        OnUpdating="SwimmerUpdating">
        <InsertParameters>
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="CurrentGroupViewDropDownList" Name="GroupID" PropertyName="SelectedValue"
                Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="USAID" Type="String" />
